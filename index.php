        ...
        <div class="row">
            <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                <img src="images/ambulance.png"
                    alt="c:\Users\chann\OneDrive\Desktop\360_F_514364850_xLOQX6SOY2qcjAIcTowsi3xYvHmhmvs0.jpg" />
                <h3>Welcome</h3>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form method="post" action="func2.php">
                            <div class="row register-form" style="padding: 5%; margin-top: 10%;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div id="register-video-container" style="display:none;">
                                            <video id="register-video" autoplay muted></video>
                                            <button type="button" class="btn btn-danger" onclick="stopFaceAuth()"
                                                style="margin-top: 5px; width: 100%; position: relative; z-index: 100;">Cancel</button>
                                        </div>
                                        <button type="button" class="btn btn-warning" onclick="startFaceRegistration()"
                                            style="margin-bottom: 10px; width: 100%;">Capture Face</button>
...
<script src="face_auth_logic.js"></script>
